      ...
      <div className="max-w-2xl bg-background rounded-xl shadow-sm p-8 md:p-12">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-8 mb-4 space-y-2 leading-relaxed">
            ...
            <li>Technical data: your IP address, browser type and version, time zone setting, browser plug-in types and versions, operating system, and other technology on the devices you use to access our website</li>
          </ul>
          <p className="mb-4 leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 leading-relaxed">
            We use OpenAI's services to generate form structures based on your descriptions. When you use our form generation feature, your form descriptions are sent to OpenAI. This data transfer is necessary for the core functionality of our service. OpenAI's use of this data is governed by their privacy policy, available at <a href="https://openai.com/privacy" className="text-primary hover:underline">https://openai.com/privacy</a>.
          </p>
          <p className="mb-4 leading-relaxed">
            We may also use other service providers for the following reasons:
          </p>
          <ul className="list-disc pl-8 mb-4 space-y-2 leading-relaxed">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-8 mb-4 space-y-2 leading-relaxed">
            <li>By email: <a href="mailto:privacy@turboform.ai" className="text-primary hover:underline">privacy@turboform.ai</a></li>
          </ul>
        </section>
      </div>
    </div>
